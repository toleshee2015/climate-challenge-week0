...
# -----------------------------------
# ROOT PATH SETUP (FIXES MODULE IMPORT ERROR)
# -----------------------------------
...
class ClimateDashboard:
    ...
    def __init__(self):
        ...
        # CLEAN COLUMN NAMES (IMPORTANT FIX FOR KEY ERRORS)
        self.data.columns = (
            self.data.columns
            .str.strip()
            .str.lower()
    ...
    def dashboard(self):
        ...
        # -----------------------------
        # TREND ANALYSIS (FIXED SAFE VERSION)
        # -----------------------------
